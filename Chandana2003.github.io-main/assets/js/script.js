...
window.addEventListener("DOMContentLoaded", function () {
  ...
  // 🔁 PASTE everything you already had her
...
navigationLinks.forEach((navLink) => {
  navLink.addEventListener("click", () => {
    const targetPage = navLink.dataset.pageTarget;
...
document.querySelectorAll(".course-toggle").forEach(button => {
  button.addEventListener("click", () => {
    ...
    button.textContent = courseList.classList.contains("hidden") ? "Show Coursework" : "Hide Coursework";
  });
});
